...
if menu == "Home":
    ...
    st.write("""Masa pendudukan militer Jepang di wilayah Indonesia (1942–1945) secara drastis dimulai dengan serangan 
    mendadak terhadap pangkalan militer Pearl Harbor di Pasifik. Peristiwa besar ini memicu jatuhnya kekuasaan kolonial
